  ...
  return {
    ...
    visitor: {
      Class(path, state) {
        ...
        const privateNamesNodes = (0, _fields.buildPrivateNamesNodes)(privateNamesMap, privateFieldsAsProperties ?? loose, state);
        ...
        if (isDecorated) {
          ...
          ({
            ...
            instanceNodes,
            wrapClass
          } = (0, _fields.buildFieldsInitNodes)(ref, path.node.superClass, props, privateNamesMap, state, setPublicClassFields ?? loose, privateFieldsAsProperties ?? loose, constantSuper ?? loose, innerBinding));
        }
